namespace Lyt.DependencyHikerReflector.Structures; 
...
public static class Solver
{
    ...
    {
        m.TryResolveField(token, out FieldInfo? fi);
        return fi;
    }
    ...
    {
        m.TryResolveMethod(token, out MethodBase? fi);
        return fi;
    }
    ...
    {
        m.TryResolveString(token, out string? fi);
        return fi;
    }
    ...
    {
        m.TryResolveSignature(token, out byte[]? fi);
        return fi;
    }
    ...
    {
        m.TryResolveType(token, out Type? fi);
        return fi;
    }
